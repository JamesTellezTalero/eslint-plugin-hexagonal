...
module.exports = {
    meta: {
        ...
        docs: {
            description:
                "Enforce hexagonal architecture folder structure for marked modules",
    ...
    create(context) {
        ...
        const requiredLayers = options.requiredLayers || [
            "application",
            "domain",
            "infrastructure"
        ];
        ...
        function validateHexagonalStructure(filePath) {
            ...
            const modules = fs.readdirSync(absoluteSrcPath).filter((file) => {
                ...
                return (
                    ...
                    fs.existsSync(path.join(modulePath, markerFile))
                );
            });
